			...
			<div class="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-4">
				<article class="flex flex-col bg-coolGray-50">
					<NuxtLink to="/burythehatchet" aria-label="Te nulla oportere reprimique his dolorum">
						<img alt="" class="object-cover w-full h-52 bg-coolGray-500" src="https://i.ibb.co/R69hV92/th-31340404165-1560x1040.jpg">
					</NuxtLink>
				...
				<article class="flex flex-col bg-coolGray-50">
					<NuxtLink to="/keystone" aria-label="Te nulla oportere reprimique his dolorum">
						<img alt="" class="object-cover w-full h-52 bg-coolGray-500" src="https://i.ibb.co/RP6LzkD/168412935-2881821135426806-7230005200482607245-n.jpg">
					</NuxtLink>
					<div class="flex flex-col flex-1 p-6">
				...
				<article class="flex flex-col bg-coolGray-50">
					<NuxtLink to="#" aria-label="Te nulla oportere reprimique his dolorum">
						<img alt="" class="object-cover w-full h-52 bg-coolGray-500" src="https://i.ibb.co/L5KCx1G/o.jpg">
					</NuxtLink>
					<div class="flex flex-col flex-1 p-6">
